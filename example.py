...
class PhotoViewer_UI(QtWidgets.QMainWindow):
    ...
    def __init__(self, ui_file_path):
        ...
        # image viewer module
        self.image_viewer = photoviewer.PhotoViewer(use_raw_image=True)
    ...
    def button_connector(self):
        ...
        self.crosshair_toolbar_pushButton.clicked.connect(partial(lambda: self.image_viewer.change_grid_type(grid_type=photoviewer.GridLine_Type.crosshair)))
        self.gridline_toolbar_pushButton.clicked.connect(partial(lambda: self.image_viewer.change_grid_type(grid_type=photoviewer.GridLine_Type.gridline)))
